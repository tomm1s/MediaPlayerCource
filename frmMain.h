...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tsmiMuteUnmute->Click += gcnew System::EventHandler(this, &frmMain::вимкнутиУвікнутиЗвукToolStripMenuItem_Click);
			// 
			// tsmiFullScreen
			// 
			...
			this->tsmiFullScreen->Click += gcnew System::EventHandler(this, &frmMain::повноекранийРежимToolStripMenuItem_Click);
			// 
			// tmsiInfo
			// 
...
private: System::Void вимкнутиУвікнутиЗвукToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	if (mediaPlayer != nullptr) {
		mediaPlayer->ToggleMute();
		// Update button appearance based on mute state
		if (mediaPlayer->IsMuted()) {
...
private: System::Void повноекранийРежимToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	if (this->FormBorderStyle == System::Windows::Forms::FormBorderStyle::None) {
		this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::Sizable;
		this->WindowState = System::Windows::Forms::FormWindowState::Normal;
		this->TopMost = false;
